...
#                                                            
# - grace input files (must be resampled first to the PCR-GLOBWB resolution)                                    
input_files["grace_total_water_storage_original"]            = '/scratch-shared/edwinhs/grace_data_downloaded_29aug2017/jpl_global_mascons/CRI/edwin-netcdf/GRCTellus.JPL.200204_201701.GLO.RL05M_1.MSCNv02CRIv02.edwin.nc'   # unit: cm
input_files["grace_scale_factor"]                            = '/scratch-shared/edwinhs/grace_data_downloaded_29aug2017/jpl_global_mascons/CRI/edwin-netcdf/CLM4.SCALE_FACTOR.JPL.MSCNv01CRIv01.edwin.nc'
                                                             
# output files:                                              
output_files = {}                                            
output_files['output_folder']                                = "/scratch-shared/edwinhs/grace_analysis/"
...
def main():
    ...
    #
    # downscaling the PCR-GLOBWB results from five minute to one degree:
